...
module purge
module use /lfs/h2/emc/lam/noscrub/emc.lam/rrfs/v1.1.3/rrfs-workflow/modulefiles
module load build_wcoss2_intel
module use /lfs/h2/emc/lam/noscrub/emc.lam/rrfs/v1.1.3/rrfs-workflow/modulefiles/tasks/wcoss2
