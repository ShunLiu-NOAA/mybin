...
#ecflow_client --host $ECF_HOST --port $ECF_PORT --alter add variable PDY 20250528 /nco_rrfs_dev_00/primary/00
ecflow_client --host $ECF_HOST --port $ECF_PORT --alter change variable PDY 20250528 /nco_rrfs_dev_12/primary/00
ecflow_client --host $ECF_HOST --port $ECF_PORT --alter change variable PDY 20250528 /nco_rrfs_dev_12/primary/00
...
#ecflow_client --host $ECF_HOST --port $ECF_PORT --load=rrfs_cycled_01.def
#ecflow_client --host $ECF_HOST --port $ECF_PORT --begin=nco_rrfs_dev_01
