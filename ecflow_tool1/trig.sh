...
ecflow_client --host $ECF_HOST --port $ECF_PORT --query variable /emc_rrfs_dev_${cyc}/primary/${cyc}:ECF_DATE
ecflow_client --host $ECF_HOST --port $ECF_PORT --query variable /emc_rrfs_dev_${cyc}/primary/${cyc}:ECF_TIME
