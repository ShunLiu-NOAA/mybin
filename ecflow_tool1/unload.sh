...
#34104
ecflow_client --host $ECF_HOST --port $ECF_PORT --delete=force yes /emc_rrfs_dev
exit
...
#ecflow_client --host $ECF_HOST --port $ECF_PORT --cancel=/emc_rrfs_dev_$cyc
#ecflow_client --host $ECF_HOST --port $ECF_PORT --delete=/emc_rrfs_dev_$cyc
ecflow_client --host $ECF_HOST --port $ECF_PORT --delete=force yes /emc_rrfs_dev_$cyc
done
exit
