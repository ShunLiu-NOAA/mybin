...
ecflow_client --host $ECF_HOST --port $ECF_PORT --alter add variable PDY 20260728 /para/primary/${g_cyc}/rrfs/v1.0/${cyc}z
ecflow_client --host $ECF_HOST --port $ECF_PORT --alter add variable PDY 20260728 /para/primary/${g_cyc}/rrfs/v1.0/cycle_end
