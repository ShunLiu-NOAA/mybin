...
for i in $(seq -w 00 23); do
    ...
    if [ -f "$FILE" ]; then
        ...
        sed -i \
            ...
            -e 's#edit QUEUE '\''dev'\''#edit QUEUE '\''devhigh'\''#g' \
            -e 's#edit PACKAGEHOME '\''/lfs/h2/emc/lam/noscrub/%EMC_USER%/rrfs/para/packages/rrfs.%rrfs_ver%'\''#edit PACKAGEHOME '\''/lfs/h2/emc/lam/noscrub/emc.lam/rrfs/ecflow/rrfs-workflow'\''#g' \
            -e 's#edit PACKAGEHOME '\''/lfs/f2/t2o/ptmp/emc/Shun.Liu/rrfs/rrfs-workflow'\''#edit PACKAGEHOME '\''/lfs/h2/emc/lam/noscrub/emc.lam/rrfs/ecflow/rrfs-workflow'\''#g' \
            -e 's#nco_rrfs#emc_rrfs#g' \
            -e 's#clock real 06.08.2025#clock real 08.06.2025#g' \
            "$FILE"
