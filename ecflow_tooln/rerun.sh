...
for cyc in $(seq -w 15 1 15); do
ecflow_client --host $ECF_HOST --port $ECF_PORT --run /emc_rrfs_dev_$cyc
done
exit
...
ecflow_client --host $ECF_HOST --port $ECF_PORT --alter add variable PDY 20250714 /emc_rrfs_dev_${cyc}/primary/${cyc}
